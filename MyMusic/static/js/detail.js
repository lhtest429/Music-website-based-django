...
//
// var audio = document.querySelector('#songlist .audio_mp3');
//
// var time_len = document.querySelector('.audio-time>span:nth-child(2)');
//
// var time_str = "";
//
// for (var i = 0; i < audio.length; i++) {
//     audio.onloadedmetadata = "getLength(this)";
//     time_len.innerHTML = time_str;
// }
//
...
//     // document.getElementById("music_len").innerHTML=minute+":"+second;
// }
//
//
// // /* 获取audio的时长 */
// // var myVid = document.getElementsByClassName("audio_mp3");
...
// //                console.log("myVid.duration",formatSeconds(myVid.duration));
// //       }
// // }
// //
// // /* 时间转换 将秒变成时：分：秒 */
...
//             audio.play();
//             // audioPlayer.src = './image/pause.png';
//             audioPlayer.src = '../pic/pause.png';
//         } else {
//             audio.pause();
//             // audioPlayer.src = './image/play.png';
//             audioPlayer.src = '../pic/play.png';
//         }
//     }, false);
//
//     // 点击进度条跳到指定点播放
